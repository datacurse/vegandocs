...
import { discordServersStore } from './_discord-servers-store'
import FiltersAndSorting from './_FiltersAndSorting'
...
export default function Home(): React.ReactNode {
  ...
  return (
    <Layout
      ...
      description="Explore a variety of Discord servers categorized by tags."
    >
      <main>
